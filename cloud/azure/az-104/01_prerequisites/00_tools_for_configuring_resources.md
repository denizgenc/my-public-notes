...
between a Bash or PowerShell session. Note: **it requires an Azure Files share** to be mounted
(since it needs a filesystem to run from), and **will store a 5 GB image in that share** to persist
the home directory.
